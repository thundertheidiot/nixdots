...
#+begin_src emacs-lisp
(defun th/mode-line ()
  (let ((ibg (face-background 'mode-line-inactive nil t))
	(vpad 10))
    (set-face-attribute 'mode-line-active nil
			:box `(:line-width (1 . ,vpad) :color ,ibg :style nil))
    (set-face-attribute 'mode-line-inactive nil
			:box `(:line-width (1 . ,vpad) :color ,ibg :style nil)))

  ;; always inactive face for modeline
  ;; TODO fix
  (custom-set-faces
   '(solaire-mode-line-face     ((t (:inherit mode-line-inactive))))
   '(solaire-mode-line-active-face     ((t (:inherit mode-line-inactive))))
