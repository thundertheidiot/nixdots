  ...
  (let* ((flavor (alist-get catppuccin-flavor catppuccin-flavor-alist))
    ...
    (setq-default mode-line-format
		  `(
		    ...
		    (:eval
		     (pcase envrc--status
		       ('none (propertize "" 'face ,(list 'quote (list :foreground text))))
		       ('on (propertize "" 'face ,(list 'quote (list :foreground green))))
		       ('error (propertize "" 'face ,(list 'quote (list :foreground red))))
		       (_ (propertize "" 'face ,(list 'quote :foreground red)))))
