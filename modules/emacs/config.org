...
;;   :general-config
;;   (:states '(normal visual motion) :keymaps 'override :prefix "SPC"
;;     "gs" '(git-gutter:popup -hunk :wk "show hunk")
;;     "ga" '(git-gutter:stage-hunk :wk "stage hunk")
...
(use-package diff-hl
  ...
  (magit-post-refresh . diff-hl-magit-port-refresh)
  ...
  :general-config
  (:states '(normal visual motion) :keymaps 'diff-hl-mode-map :prefix "SPC"
