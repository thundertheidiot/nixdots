...
(use-package eshell
  ...
  :general
  (:states '(normal visual insert emacs motion) :prefix "SPC" :global-prefix "C-SPC" :keymaps 'override
...
(defmacro prx (&rest rx-sexp) ;; Stolen from https://youtube.com/watch?v=9xLeqwl_7n0
